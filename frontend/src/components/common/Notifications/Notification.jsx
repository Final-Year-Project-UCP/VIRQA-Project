        ...
        {hasNextPage && (
          <div className="flex justify-center mt-6 sm:mt-8">
            <button
              ...
              className="w-full sm:w-auto px-6 py-3 sm:py-2.5 bg-white border border-gray-200 text-gray-600 font-medium rounded-xl hover:bg-gray-50 hover:border-gray-300 transition-all duration-200 shadow-sm active:scale-[0.98]"
            >
